...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if param == "BPIC12":
            dfg, start_activities, end_activities = pm4py.discover_dfg(BPIC12, case_id_key='case:concept:name', activity_key='concept:name', timestamp_key='time:timestamp')
            ...
            dfg, start_activities, end_activities = pm4py.discover_dfg(BPIC14_f, case_id_key='case:concept:name', activity_key='concept:name', timestamp_key='time:timestamp')
